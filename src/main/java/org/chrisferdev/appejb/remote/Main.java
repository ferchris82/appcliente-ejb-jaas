...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            service = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote-jaas/ServiceEjb!org.chrisferdev.webapp.ejb.service.ServiceEjbRemote?stateful");
            service2 = (ServiceEjbRemote) ctx.lookup("ejb:/appejb-remote-jaas/ServiceEjb!org.chrisferdev.webapp.ejb.service.ServiceEjbRemote?stateful");
